...
#define CO_CONFIG_GTW (CO_CONFIG_GTW_ASCII_PRINT_LEDS|CO_CONFIG_GTW_ASCII|CO_CONFIG_GTW_ASCII_SDO \
		|CO_CONFIG_GTW_ASCII_NMT|CO_CONFIG_GTW_ASCII_LSS|CO_CONFIG_GTW_ASCII_PRINT_HELP|CO_CONFIG_GTW_ASCII_LOG)
#endif
...
typedef struct {
    ...
    uint8_t commBuf[255 + 1]; /**< Command buffer of usable size
    ...
    uint8_t logBuf[255 + 1]; /**< Message log buffer of usable size
